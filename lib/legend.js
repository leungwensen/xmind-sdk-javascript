...
class Legend extends DomMixin {
  constructor(options) {
    ...
    me.markerDescriptionsNode = utils.findOrCreateChildNode(me.doc, CONST.TAG_MARKER_DESCRIPTIONS);
    sheet.legend = me;
  }
  ...
  addMarkerDescription(markerId, description) {
    ...
    utils.findOrCreateChildNode(me.markerDescriptionsNode, CONST.TAG_MARKER_DESCRIPTION, attrs);
    return me;
  }
  ...
  removeMarkerDescription(markerId) {
    ...
    const attrs = {};
    attrs[CONST.ATTR_MARKERID] = markerId;
    utils.removeChildNode(me.markerDescriptionsNode, CONST.TAG_MARKER_DESCRIPTION, attrs);
    return me;
  }
